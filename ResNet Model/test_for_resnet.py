...
from model import ResNetSteeringModel
...
# Paths
TEST_DATA_DIR = "Dataset/testing_data"  # Update to your test dataset directory
MODEL_PATH = "results_best_model.pth"  # Path to the saved model

# Parameters
BATCH_SIZE = 32
THRESHOLD = 0.01  # Define threshold for binary classification
...
model = ResNetSteeringModel().to(device)
